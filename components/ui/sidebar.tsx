        ...
        style={
          {
            ...
            "--sidebar-mobile-offset": "0px",
            "--sidebar-mobile-height": "100svh",
            ...style,
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          overlayClassName="!top-(--sidebar-mobile-offset) !bottom-auto !h-(--sidebar-mobile-height)"
          dir={dir}
          data-sidebar="sidebar"
          data-slot="sidebar"
          data-mobile="true"
          className="!top-(--sidebar-mobile-offset) !bottom-auto !h-(--sidebar-mobile-height) w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "absolute inset-y-0 hidden h-full w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
